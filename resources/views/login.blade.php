    ...
    <div class="px-16 bg-gray-100">
        ...
        <header>
            <div class="px-4 py-4 flex justify-between items-center">
                ...
                <div class="">
                    <button type="button" class="bg-orange-custom px-4 py-2 rounded-lg w-48">
            ...
            <div class="w-full">
                ...
                <div class="mt-8 grid grid-cols-5 gap-2">
                    ...
                    <div class="flex-1 text-gray-700 border shadow-lg border-gray-400 rounded-lg">
                        ...
                        {{-- product description --}}
                        <div class="px-2 py-4 bg-white rounded-lg relative -mt-2 leading-tight hover:bg-gray-100 h-24 overflow-y-hidden">

                            {{-- show element --}}
                            <p class="normal-case mb-2 font-semibold leading-tight text-sm">
                                Customized Pre-filter untuk Blower dan FFU</p>
                            <p class="uppercase text-gray-600 leading-tight text-xs">pt. maju jaya prima perkasa abadi</p>

                            {{-- hidden element --}}
                            <div class="">
                                <p class="mt-2 mb-4 text-xs text-gray-500">Jakarta Barat</p>
                                <div class="mb-4 rounded-full w-6 h-6 bg-gray-500 flex justify-around items-center px-2 py-2">
                                    <p class="text-gray-300 text-xs">SNI</p>
                                </div>
                                <p class="font-bold mb-4"><span class="text-red-500 font-bold">Rp250.000</span> 
                                    <span class="text-sm">/ pc</span></p>
                                <p class="text-xs mb-4 text-gray-500">Visit in order to contact the seller</p>
                                <button class="bg-blue-600 text-white px-4 py-2 w-full rounded-lg font-sans font-bold leading-tight font-sm"><p>See Product</p></button>
                            </div>
                        </div>
                        {{-- end product description --}}
                    </div>
                    {{-- end div product image --}}
