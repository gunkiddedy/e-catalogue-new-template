<template>
  <div>
    <div class="lg:px-16 bg-gray-100 sm:px-4">
      <header-component></header-component>
      <div class="flex px-4 py-4 mt-4">
        <!-- SIDEBAR (be a modal when clicked on one of the button) -->
        <div
          class="bg-white h-full w-64 rounded-lg mr-6 shadow hidden lg:block md:hidden"
          :class="{
            relative: showModalSidebar,
            'inset-0': showModalSidebar,
            'z-50': showModalSidebar,
          }"
        >
          <div class="bg-blue-500 rounded-t-lg h-12">
            <p class="px-8 py-3 text-gray-100 font-semibold">Filter</p>
          </div>
        ...
        <div
          ...
          class="h-full w-full"
          :class="{
            relative: showModalProv,
            'inset-0': showModalProv,
            'z-50': showModalProv,
          }"
        >
          <div class="bg-white border-0 rounded-lg shadow-lg px-6 py-4">
            <div class="grid grid-cols-5 gap-4">
              <div>
                <p class="font-semibold text-sm uppercase text-gray-600">
                  {{ islands[0].name }}
                </p>
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[0].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 hover:bg-gray-100 font-semibold cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[1].provinsis"
                    :key="i"
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[2].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[3].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[4].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
            ...
            <div class="grid grid-cols-5 gap-4">
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[5].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[6].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div>
                ...
                <ul class="mt-2">
                  <li
                    v-for="(prov, i) in islands[7].provinsis"
                    :key="i"
                    class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                    @click="handleSelectingProvinsi(prov.id, prov.name)"
                  >
              ...
              <div class="col-span-2">
                <div class="flex justify-end items-center">
                  ...
                  <button
                    ...
                    class="ml-4 flex items-center text-white border border-gray-500 bg-gray-500 hover:bg-gray-600 hover:text-gray-100 font-bold text-sm px-6 py-1 rounded focus:outline-none"
                    type="button"
                  >
                    <svg
                      v-if="isResetingProvinsi"
                      class="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
        ...
        <div
          v-if="showModalKab"
          class="w-2/7 overflow-y-auto"
          :class="{
            relative: showModalKab,
            'inset-0': showModalKab,
            'z-50': showModalKab,
            'h-full': !isSelectingProvId,
            'h-82': isSelectingProvId,
          }"
        >
          <div class="bg-white border-0 rounded-lg shadow-lg px-6 py-4">
            <div class="grid grid-cols-1">
              <div class="text-left">
                ...
                <div
                  class="flex flex-col text-sm text-gray-500 hover:text-gray-600 mt-2 font-semibold"
                >
                  <ul class="mt-2">
                    <li
                ...
                <div class="flex content-end my-4">
                  ...
                  <button
                    ...
                    class="ml-2 flex items-center text-white border border-gray-500 bg-gray-500 hover:bg-gray-600 hover:text-gray-100 font-bold text-sm px-6 py-1 rounded focus:outline-none"
                    type="button"
                  >
                    <svg
                      v-if="isResetingKabupaten"
                      class="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
        ...
        <div
          ...
          class="h-full w-auto"
          :class="{
            relative: showModalCat,
            'inset-0': showModalCat,
            'z-50': showModalCat,
          }"
        >
          <div class="bg-white border-0 rounded-lg shadow-lg px-6 py-4">
                ...
                >
                  <ul class="mt-2">
                    <li
                      ...
                      :key="i"
                      class="text-xs text-gray-500 hover:text-gray-600 font-semibold hover:bg-gray-100 cursor-pointer mt-1"
                      @click="handleSelectingCategory(cat.id, cat.name)"
                    >
        ...
        <!-- SUB CATEGORY MODAL-->
        <div
          v-if="showModalSubCat"
          class="h-full w-auto"
          :class="{
            relative: showModalSubCat,
            'inset-0': showModalSubCat,
            'z-50': showModalSubCat,
          }"
        >
          <div class="bg-white border-0 rounded-lg shadow-lg px-6 py-4">
            <div class="grid grid-cols-1">
                ...
                >
                  <ul class="mt-2">
                    ...
                    >
                      <span
                        class="text-pink-400"
                        v-if="isSelectingSubCatId === subcat.id"
                      >
                        {{ subcat.name }}
                      </span>
                      <span v-else>
  ...
  methods: {
    ...
    provinsiModal: function () {
      axios
        ...
        .then((response) => {
          axios
            .get("/api/get-island-with-provinsis")
            .then((response) => {
    ...
    kabupatenModal: function () {
      axios
        ...
        .then((response) => {
          axios
            .get("/api/get-kabupatens-by-provinsi-id", {
              params: {
    ...
    subcategoryModal: function () {
      axios
        ...
        .then((response) => {
          axios
            .get("/api/get-subcategories-by-category-id", {
              params: {
